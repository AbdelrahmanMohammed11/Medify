...
from stores.LLM.LLMEnums import DocTypes
...
class NLPController(BaseController):
    def __init__(self, 
                 vectordb_client, generation_client,
    ...
    def create_collection_name(self, project_id: str):
        return f"collection__{project_id}".strip()
    ...
    async def index_into_vector_db(self, project: Project, chunks: List[DataChunk],
        ...
        vectors = self.embedding_client.embed_text(text=texts,
                                            document_type=DocTypes.DOCUMENT.value)
    ...
    async def search_vector_db_collection(self, project: Project,
        ...
        vectors = self.embedding_client.embed_text(text=text,
                                                document_type=DocTypes.QUERY.value)
    ...
    async def answer_rag_question(self, project: Project, query: str, limit: int = 10):
        ...
        # step3: Constract Generation Client Prompts
        chat_history = [
